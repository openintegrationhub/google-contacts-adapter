...
const { appendToSheet } = require('./../utils/helpers');
const { getAccessToken, oihPersonToSheet } = require('../transformations/oihPersonToSheet');
...
async function processAction(msg, cfg) {
  try {
    ...
    */
    ...
    await appendToSheet(transformedObject.data, token, cfg.sheetId);
