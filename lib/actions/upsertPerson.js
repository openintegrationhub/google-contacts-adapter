...
const { upsertObject, getAccessToken, deleteObject } = require('./../utils/helpers');
...
async function processAction(msg, cfg) {
  try {
    ...
    */
    ...
    if (msg.data.deleteRequest) {
      const { status, timestamp } = await deleteObject(token, recordUid);
